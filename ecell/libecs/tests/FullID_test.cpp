...
{
    BOOST_CHECK_THROW( FullID::parse( "Variable" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( "Variable:" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( "Variable:::" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( "" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( ":" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( "::" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( ":::" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( ":/:A" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( "::/" ), BadFormat );
    BOOST_CHECK_THROW( FullID::parse( "UNKNOWN:/UNKNOWN:" ), BadFormat );
}

BOOST_AUTO_TEST_CASE(testAssignment)
{
    FullID aFullID( FullID::parse( "Variable:/test:TEST" ) );
    FullID anAssignee( EntityType::NONE, SystemPath::parse(""), "" );
