...
char const StepperMaker_C_rcsid[] = "$Id$";
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//
...
//template MultiClassModuleMaker<Stepper>;
...
Stepper* StepperMaker::make(const string& classname) throw(CantInstantiate)
{
  Stepper* instance = allocator(classname)();
