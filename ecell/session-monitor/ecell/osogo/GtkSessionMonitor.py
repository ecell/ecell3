...
#
    ...
    def __init__(self, aSimulator = None ):
        ...
        # -------------------------------------
        self.thePluginManager = OsogoPluginManager( self, config.plugin_path )
        ...
        aLoggerWindow       = LoggerWindow(  self )
        anInterfaceWindow   = InterfaceWindow( self )
        aStepperWindow      = StepperWindow(  self )
        aBoardWindow        = BoardWindow(  self )
        aMainWindow         = MainWindow( self ) 
    ...
    def createEntityListWindow( self, rootWidget = 'EntityListWindow', aStatusBar=None ):
        ...
        if len(self.theModelName) > 0:
            ...
            anEntityListWindow = EntityListWindow( self, rootWidget, aStatusBar )
