...
class SimulationButton:
	...
	def __init__( self ):
                ...
                # Image
                self.startImage = os.environ['SESSIONMONITORPATH'] + os.sep + "icon_start.png"
                self.stopImage = os.environ['SESSIONMONITORPATH'] + os.sep + "icon_stop.png"
...
class LogoAnimation:
    ...
    def __init__( self ):
        ...
        self.image = gtk.Image()
        self.image.set_from_file( os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32.png" )
        self.image.show()

        self.iconList = [ os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-1.png",
                          os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-2.png",
                          os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-3.png",
                          os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-4.png",
                          os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-5.png",
                          os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-6.png",
                          os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-7.png",
                          os.environ['SESSIONMONITORPATH'] + os.sep + "ecell32-8.png",
